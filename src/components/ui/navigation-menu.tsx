...
function NavigationMenuList({
  ...
  return (
    <NavigationMenuPrimitive.List
      className={cn(
        "flex flex-1 list-none items-stretch justify-center gap-0",
        className
      )}
...
function NavigationMenuContent({
  ...
  return (
    <NavigationMenuPrimitive.Content
      className={cn(
        "data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95 data-[state=closed]:fade-out-0 top-0 left-0 w-full p-1.5 ease-out data-[state=closed]:animate-out data-[state=open]:animate-in **:data-[slot=navigation-menu-link]:focus:outline-none **:data-[slot=navigation-menu-link]:focus:ring-0 group-data-[viewport=false]/navigation-menu:top-full group-data-[viewport=false]/navigation-menu:overflow-hidden group-data-[viewport=false]/navigation-menu:bg-popover group-data-[viewport=false]/navigation-menu:text-popover-foreground group-data-[viewport=false]/navigation-menu:shadow-lg group-data-[viewport=false]/navigation-menu:ring-1 group-data-[viewport=false]/navigation-menu:ring-foreground/5 group-data-[viewport=false]/navigation-menu:duration-150 md:absolute md:w-auto group-data-[viewport=false]/navigation-menu:dark:ring-foreground/10",
        className
      )}
