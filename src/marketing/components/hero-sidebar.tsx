      ...
      content: (
        <div className="h-full w-150 overflow-y-auto border border-gray-200 border-l-0 bg-white p-8 shadow-xl">
          <div className="mb-6 flex items-center justify-between">
            ...
            <Link
              className="font-bold text-(--color-orange) text-xs hover:underline"
              href={`/courses/${item.slug}`}
            >
              View All Category Courses &rarr;
            </Link>
          </div>
          ...
          <ul className="flex flex-col gap-4">
            <li>
              <Link
                ...
                href="/courses"
              >
                PECB Certified ISO 27001 Information Security
              </Link>
            </li>
            <li>
              <Link
                ...
                href="/courses"
              >
                PECB Certified ISO 9001 Quality Management
              </Link>
            </li>
          </ul>
        </div>
